...
import 'package:flutter_fly_plout/http/HttpUtils.dart';
import 'package:flutter_fly_plout/module/login/bean/user.dart';
...
class UserApi {
  ...
  handleAddShelf() async {
    var result = await HttpUtils.request('/user', method: HttpUtils.POST, data: {
      'id': 1,
    });
  }
